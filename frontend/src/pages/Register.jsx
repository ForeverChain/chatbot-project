...
const Register = () => {
  ...
  const onSubmit = async (e) => {
    ...
    if (password.length < 6) {
      setError('Нууц үг дор хаяж 6 тэмдэгтэй байх ёстой');
      return;
    }
    ...
    try {
      ...
      setError(err.response?.data?.error || 'Бүртгэл амжилтгүй боллоо');
    } finally {
      setLoading(false);
    }
  };
        ...
        <div className="p-8">
          <div className="text-center mb-8">
            ...
            <p className="mt-2 text-sm text-gray-600">
              Манай чатбот платформд нэгдээрэй
            </p>
          </div>
